const config = {
    ...
    users: {
        ownerId: '750517144432934972', // The bot owner ID, which is you.
        developers: ['750517144432934972'] // The bot developers, remember to include your account ID with the other account IDs.
    },
